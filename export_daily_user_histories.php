...
$pdf->SetTitle('Filtered User Repayment Histories');
...
// Fetch repayment history from the database
include 'db.php'; // Include your database connection

$query = "
    SELECT u.name, r.repayment_amount, r.repayment_date
    FROM users_details u
    LEFT JOIN repayment_history r ON u.id = r.user_id
";
...
// Add content to PDF
$html = '<h1>Filtered User Repayment Histories</h1>';
...
$pdf->Output('filtered_user_histories.pdf', 'I');
?>